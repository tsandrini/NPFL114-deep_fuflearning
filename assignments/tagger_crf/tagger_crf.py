...
class Model(tf.keras.Model):
    ...
    def crf_loss(
        ...
        # print(
        #     gold_labels.dtype, gold_labels.row_lengths(), gold_labels.to_tensor().shape
        # )
        # print(logits.dtype, logits.row_lengths(), logits.to_tensor().shape)
        crf, _ = tfa.text.crf_log_likelihood(
