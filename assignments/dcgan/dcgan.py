    ...
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        self.generator = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Dense(1024, use_bias=False, activation=None),
                tf.keras.layers.BatchNormalization(),
                tf.keras.layers.Activation("relu"),
                tf.keras.layers.Dense(
                    MNIST.H // 4 * MNIST.W // 4 * 64, use_bias=False, activation=None
                ),
                tf.keras.layers.BatchNormalization(),
                tf.keras.layers.Activation("relu"),
                tf.keras.layers.Reshape([MNIST.H // 4, MNIST.W // 4, 64]),
                tf.keras.layers.Conv2DTranspose(
                    32, 4, 2, padding="same", use_bias=False, activation=None
                ),
                tf.keras.layers.BatchNormalization(),
                tf.keras.layers.Activation("relu"),
                tf.keras.layers.Conv2DTranspose(
                    1, 4, 2, padding="same", activation="sigmoid"
                ),
            ]
        )
        ...
        self.discriminator = tf.keras.Sequential(
            [
                ...
                tf.keras.layers.Conv2D(
                    32, 5, 1, padding="same", use_bias=False, activation=None
                ),
                tf.keras.layers.BatchNormalization(),
                tf.keras.layers.Activation("relu"),
                tf.keras.layers.MaxPool2D(2, 2),
                tf.keras.layers.Conv2D(
                    64, 5, 1, padding="same", use_bias=False, activation=None
                ),
                tf.keras.layers.BatchNormalization(),
                tf.keras.layers.Activation("relu"),
                tf.keras.layers.MaxPool2D(2, 2),
